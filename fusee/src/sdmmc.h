...
static inline volatile sdmmc1_registers_t *get_sdmmc1_regs(void) {
    return (volatile sdmmc_registers_t *)(0x700B0000);
}

static inline volatile sdmmc1b_registers_t *get_sdmmc1b_regs(void) {
    return (volatile sdmmc_registers_t *)(0x700B0000 + 0x1000);
}

static inline volatile sdmmc2_registers_t *get_sdmmc2_regs(void) {
    return (volatile sdmmc_registers_t *)(0x700B0200);
}

static inline volatile sdmmc2b_registers_t *get_sdmmc2b_regs(void) {
    return (volatile sdmmc_registers_t *)(0x700B0200 + 0x2000);
}

static inline volatile sdmmc3_registers_t *get_sdmmc3_regs(void) {
    return (volatile sdmmc_registers_t *)(0x700B0400);
}

static inline volatile sdmmc3b_registers_t *get_sdmmc3b_regs(void) {
    return (volatile sdmmc_registers_t *)(0x700B0400 + 0x3000);
}

static inline volatile sdmmc4_registers_t *get_sdmmc4_regs(void) {
    return (volatile sdmmc_registers_t *)(0x700B0600);
}

static inline volatile sdmmc4b_registers_t *get_sdmmc4b_regs(void) {
