...
namespace ams::secmon::smc {
    ...
    namespace {
        ...
        constexpr const pkg1::MemorySize DramIdToMemorySize[fuse::DramId_Count] = {
            ...
            [fuse::DramId_MarikoIowaSamsung1z4GB] = pkg1::MemorySize_4GB,
            [fuse::DramId_MarikoHoagSamsung1z4GB] = pkg1::MemorySize_4GB,
            [fuse::DramId_MarikoAulaSamsung1z4GB] = pkg1::MemorySize_4GB,
