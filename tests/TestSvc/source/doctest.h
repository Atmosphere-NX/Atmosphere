...
{
    std::ostream* cout;        // stdout stream - ::doctest::get_cout() by default
    std::ostream* cerr;        // stderr stream - ::doctest::get_cerr() by default
...
namespace {
    ...
    DOCTEST_NORETURN void throw_exception(Ex const& e) {
        ...
        throw e;
#else  // DOCTEST_CONFIG_NO_EXCEPTIONS
        ::doctest::get_cerr() << "doctest will terminate because it needed to throw an exception.\n"
...
// =================================================================================================
    ...
    public:
        ...
        XmlWriter( std::ostream& os = ::doctest::get_cout() );
        ~XmlWriter();
...
int Context::run() {
    ...
    // stdout by default
    p->cout = &::doctest::get_cout();
    p->cerr = &::doctest::get_cerr();
