...
#define AMS_PGL_SF_I_EVENT_OBSERVER_INTERFACE_INFO(C, H)                                                        \
    AMS_SF_METHOD_INFO(C, H, 0, Result, GetShellEvent,         (ams::sf::OutCopyHandle out),             (out)) \
    AMS_SF_METHOD_INFO(C, H, 1, Result, GetShellEventInfo,     (ams::sf::Out<pm::ProcessEventInfo> out), (out))
