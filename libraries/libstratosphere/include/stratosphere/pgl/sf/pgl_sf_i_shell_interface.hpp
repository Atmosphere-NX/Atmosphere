...
#define AMS_PGL_I_SHELL_INTERFACE_INTERFACE_INFO(C, H)                                                                                                                                                                                \
    ...
    AMS_SF_METHOD_INFO(C, H,  4, Result, GetProgramLaunchPropertyFromHost,      (ams::sf::Out<pgl::ProgramLaunchProperty> out, const ams::sf::InBuffer &content_path),          (out, content_path))                                  \
    AMS_SF_METHOD_INFO(C, H,  5, Result, GetRunningApplicationProcessId,        (ams::sf::Out<os::ProcessId> out),                                                              (out))                                                \
    AMS_SF_METHOD_INFO(C, H,  6, Result, BoostSystemMemoryResourceLimit,        (u64 size),                                                                                     (size))                                               \
    AMS_SF_METHOD_INFO(C, H,  7, Result, IsRunningProcess,                      (ams::sf::Out<bool> out, os::ProcessId process_id),                                             (out, process_id))                                    \
    ...
    AMS_SF_METHOD_INFO(C, H, 12, Result, TriggerSnapShotDumper,                 (pgl::SnapShotDumpType dump_type, const ams::sf::InBuffer &arg),                                (dump_type, arg),                hos::Version_10_0_0) \
    AMS_SF_METHOD_INFO(C, H, 20, Result, CreateShellEvent,                      (ams::sf::Out<ams::sf::SharedPointer<pgl::sf::IEventObserver>> out),                            (out))                                                \
