...
#define AMS_I2C_I_MANAGER_INTERFACE_INFO(C, H)                                                                                                                                                                                                                                                                                 \
    ...
    AMS_SF_METHOD_INFO(C, H,  2, Result, HasDevice,         (ams::sf::Out<bool> out, i2c::I2cDevice device),                                                                                                               (out, device),                                              hos::Version_1_0_0, hos::Version_5_1_0) \
    AMS_SF_METHOD_INFO(C, H,  3, Result, HasDeviceForDev,   (ams::sf::Out<bool> out, i2c::I2cDevice device),                                                                                                               (out, device),                                              hos::Version_1_0_0, hos::Version_5_1_0) \
