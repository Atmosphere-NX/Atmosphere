...
#define AMS_TMA_I_FILE_MANAGER_INTERFACE_INFO(C, H)                                                                                                                                                                                                 \
    AMS_SF_METHOD_INFO(C, H,  0, Result, OpenFile,             (sf::Out<sf::SharedPointer<tma::IFileAccessor>> out, const tma::Path &path, bool case_sensitive),                        (out, path, case_sensitive))                                \
    ...
    AMS_SF_METHOD_INFO(C, H,  5, Result, OpenDirectory,        (sf::Out<sf::SharedPointer<tma::IDirectoryAccessor>> out, const tma::Path &path, bool case_sensitive),                   (out, path, case_sensitive))                                \
    ...
    AMS_SF_METHOD_INFO(C, H,  8, Result, DeleteDirectory,      (const tma::Path &path, bool case_sensitive),                                                                            (path, case_sensitive))                                     \
