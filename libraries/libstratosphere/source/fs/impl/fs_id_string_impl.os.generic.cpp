...
namespace ams::fs::impl {
    ...
    template<> const char *IdString::ToString<pkg1::KeyGeneration>(pkg1::KeyGeneration id) {
        static_assert(pkg1::KeyGeneration_Current == pkg1::KeyGeneration_23_0_0);
        switch (id) {
            ...
            case KeyGeneration_22_0_0: return "22.0.0-22.5.0";
            case KeyGeneration_23_0_0: return "23.0.0";
